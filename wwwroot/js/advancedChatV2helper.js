...
function receiveaddnewRoomMessage(maxRoom, roomId, roomName, userId) {
    ...
    var ui = document.getElementById("ulroomTabs");
    var li = document.getElementById("liaddnewRoom");
...
function receivepublicMessage(roomId, userId, username, message) {
    var ulmessagesList = document.getElementById(`ulmessagesList${roomId}`);
...
function readypublicMessage(roomId) {
    var inputMsg = document.getElementById(`inputMessage${roomId}`);
    var sendButton = document.getElementById(`btnMessage${roomId}`);
...
function receiveprivateMessage(
    ...
    var ulmessagesList = document.getElementById(chatboxName);
...
function readyprivateMessage() {
    var inputMsg = document.getElementById("inputMessagePrivate");
    var sendButton = document.getElementById("btnMessagePrivate");
...
function receivedeleteRoomMessage(deleted, selected) {
    var ui = document.getElementById("ulroomTabs");
    var link = document.getElementById(`room${deleted}-tab`);

    var li = link.parentNode;
    /*let ui = li.parentNode;*/

    var divrooms = document.getElementById("divRooms");
    var childdiv = document.getElementById(`room${deleted}`);
    ...
    setTimeout(function () {
        ...
        var liaddnew = document.getElementById("liaddnewRoom");
        ...
        if (Number(selected) > 0) {
            if (changetab) {
                var newdiv = document.getElementById(`room${selected}`);
                var link1 = document.getElementById(`room${selected}-tab`);

                var newli = link1.parentNode;
...
function receiveopenprivateChat(userId, userName, tabchange) {
    var pubtab = document.getElementById("public-tab");
    var pribtab = document.getElementById("private-tab");

    var pubtabbox = document.getElementById("publictabbox");
    var pribtabbox = document.getElementById("privatetabbox");
    ...
    var div = document.getElementById("list-tab");
    ...
    var div1 = document.getElementById("nav-tabContent");
...
function receivedeleteprivateChat(chatid) {
    var p = document.getElementById(chatid);
    var li = p.parentNode;
